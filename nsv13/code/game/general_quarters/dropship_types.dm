...
/obj/structure/overmap/small_craft/transport/cargo //K13
	name = "FL-109 Heron Heavy Utility Craft"
	desc = "A FL-109 utility craft. Purpose built for carrying quantities of volatile cargo, the Heron is a ship that serves as the logistical backbone for any capital-sized hull. Drag and drop crates / ore boxes to load them into its cargo hold."
	icon = 'nsv13/icons/overmap/new/nanotrasen/cargo.dmi'
	icon_state = "cargolight"
	armor = list("melee" = 70, "bullet" = 70, "laser" = 70, "energy" = 40, "bomb" = 40, "bio" = 100, "rad" = 90, "fire" = 90, "acid" = 80, "overmap_light" = 15, "overmap_medium" = 5, "overmap_heavy" = 90)
	sprite_size = 32
	canopy_open = FALSE
	damage_states = FALSE //temp (yeah I totally won't forget to add these)
	max_integrity = 175 //slightly less tankier. It's not supposed to be used in combat.
	pixel_w = 10
	pixel_z = -32
	flight_pixel_w = -30
	flight_pixel_z = -32
	...
	speed_limit = 4
	loadout_type = LOADOUT_UTILITY_ONLY
	possible_interior_maps = list(/datum/map_template/dropship/cargo)
	components = list(/obj/item/fighter_component/fuel_tank/tier2,
						/obj/item/fighter_component/avionics,
						/obj/item/fighter_component/apu,
						/obj/item/fighter_component/armour_plating,
...
/datum/map_template/dropship/cargo
	name = "FL-109 Heron Interior"
	mappath = "_maps/templates/boarding/cargo.dmm" //it's a big boy, alright!
