...
/turf/closed/wall/steel/medical
...
/turf/closed/wall/r_wall/interior
	icon_state = "reinf"
	texture = "reinf_over"
	icon = 'nsv13/icons/turf/wall_masks.dmi'
	color = COLOR_WALL_GUNMETAL

/turf/closed/wall/r_wall/command
	icon_state = "reinf"
	texture = "reinf_over"
	icon = 'nsv13/icons/turf/wall_masks.dmi'
...
/turf/closed/wall/r_wall/munitions
	icon_state = "wood"
	icon = 'nsv13/icons/turf/wall_masks.dmi'
	color = COLOR_SEDONA

/turf/closed/wall/r_wall/valkyrie/hull
	icon_state = "wood"
	icon = 'nsv13/icons/turf/wall_masks.dmi'
