...
/obj/item/radio/headset/munitions/atc
	...
	icon = 'nsv13/icons/obj/custom_radio.dmi'
	desc = "A headset capable of accessing the Colonial blue channel via a special DRADIS satellite uplink, allowing fighter pilots to communicate from anywhere inside of Colonial space. Use :q to access the air traffic control frequency. Use :w to access the department frequency. Use :c to access the command department frequency."
...
/obj/item/radio/headset/munitions/pilot
	...
	desc = "A headset capable of accessing the Colonial blue channel via a special DRADIS satellite uplink, allowing fighter pilots to communicate from anywhere inside of Colonial space. Use :q to access the air traffic control frequency. Use :w to access the department frequency while on the ship."
	icon_state = "mun_headset"
