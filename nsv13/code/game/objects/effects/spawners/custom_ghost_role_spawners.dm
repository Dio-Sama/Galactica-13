...
/obj/effect/mob_spawn/human/nsv13/nt_prisoner/
	...
	desc = "Although this stasis pod looks medicinal, it seems as though it's meant to preserve something for a very long time. It has a prisoner's identification number and a Colonial insignia on it. It seems like it's been ashed around quite a bit."
	mob_name = "NT Prisoner"
	icon = 'icons/obj/machines/sleeper.dmi'
	icon_state = "sleeper"
	roundstart = FALSE
	death = FALSE
	flavour_text = "<b>You are a </b><span class='big bold'>prisoner of the Syndicate</span><b>. You are a corporation employee captured by the syndicate. Your objective is to escape the ship you are on alive. Hopefully your extensive training will help you!</b><span class='big bold'><span class='danger'>THIS IS NOT AN ANTAGONIST ROLE!</span></span>"
