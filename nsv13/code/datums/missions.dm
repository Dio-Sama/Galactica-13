...
/datum/nsv_mission
	...
	var/list/valid_factions = list("kobol")
...
/datum/nsv_mission/kill_ships
	...
	var/list/target_factions = list(FACTION_ID_CYLON, FACTION_ID_PIRATES)
...
/datum/nsv_mission/kill_ships/syndicate
	...
	target_faction = list("kobol")
	target_factions = list(FACTION_ID_KOBOL)
...
/datum/nsv_mission/kill_ships/system/syndicate
	valid_factions = list("cylons")
	target_faction = list("kobol")
	target_factions = list(FACTION_ID_KOBOL)
	system_alignment = list("kobol","unaligned","uncharted")
	rewards = list(/obj/item/stack/telecrystal/twenty="20 telecrystals",
								/obj/structure/closet/crate/nsv_mission_rewards="an ammo crate")
...
/datum/nsv_mission/cargo/
	...
	var/destination_faction = FACTION_ID_KOBOL
