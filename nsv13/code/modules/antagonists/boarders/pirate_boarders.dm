...
/datum/antagonist/pirate/boarder/greet()
	...
	to_chat(owner, "<B>You've managed to dock within proximity of a Colonial war vessel. You're outnumbered, outgunned, and under prepared in every conceivable way, but if you can manage to successfully pull off a heist on this vessel, it'd be enough to put your pirate crew on the map.</B>")
