...
/datum/trader/aerelon
	name = "Aerelon"
	desc = "Farming world with a side of light industry."
	shortname = "ARL"
	faction_type = FACTION_ID_KOBOL
	sold_items = list(/datum/trader_item/ship_repair/tier2, /datum/trader_item/flak,/datum/trader_item/fighter/light,/datum/trader_item/fighter/heavy,/datum/trader_item/fighter/utility, /datum/trader_item/fighter/judgement, /datum/trader_item/fighter/prototype)
	station_type = /obj/structure/overmap/trader/aerelon

/datum/trader/gantry
	name = "Orbital Scaffolding"
	desc = "Drydocks able to facilitate anything up to and including a battlestar.."
	shortname = "DDK"
	faction_type = FACTION_ID_KOBOL
	sold_items = list(/datum/trader_item/ship_repair/tier2, /datum/trader_item/flak,/datum/trader_item/fighter/light,/datum/trader_item/fighter/heavy,/datum/trader_item/fighter/utility, /datum/trader_item/fighter/judgement, /datum/trader_item/fighter/prototype)
	station_type = /obj/structure/overmap/trader/gantry
...
/datum/trader/ui_data(mob/user)
	...
	data["desc"] = desc
	data["image"] = image
	data["theme"] = (faction_type == FACTION_ID_KOBOL) ? "ntos" : "syndicate"
	...
	if(OM)
		account = (OM.faction == "kobol") ? ACCOUNT_CAR : ACCOUNT_SYN
