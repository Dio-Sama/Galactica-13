...
/datum/star_system/proc/add_ship(obj/structure/overmap/OM, turf/target_turf)
	...
	if(target_turf)
		...
		else if(OMS.faction == "kobol" || OMS.faction == "solgov")	//NT and ally fleets arrive on the left side of the system. Syndies on the right side.
...
/obj/machinery/computer/ship/ftl_computer
	...
	var/tier = 1
	var/faction = "kobol" //For ship tracking. The tracking feature of the FTL compy is entirely so that antagonists can hunt the NT ships down
