...
/obj/structure/overmap/trader/aerelon
	name = "Aerelon Orbital City"
	icon_state = "planet_green"

/obj/structure/overmap/trader/commrelay
	name = "Communications Relay"
	icon_state = "relay"

/obj/structure/overmap/trader/colonial
	name = "Orbital Habitat"
	icon_state = "colonial"

/obj/structure/overmap/trader/gantry
	name = "Orbital Scaffolding"
	icon_state = "gantry"
	boarding_interior = new /datum/map_template/("_maps/templates/boarding/orbitalhabitat.dmm")
