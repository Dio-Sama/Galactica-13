...
/obj/item/clothing/under/ship/enlistedcolonial
	name = "Colonial Enlisted uniform"
	desc = "An extremely comfortable piece of standard equipment, this uniform has been made with utility in mind. Boasting large amounts of spacious pockets and camo green, this uniform has you covered in a plethora of situations."
	icon_state = "enlistedcolonial"
	item_color = "enlistedcolonial"
	item_state = "bl_suit"
	sensor_mode = SENSOR_COORDS
	random_sensor = FALSE
	can_adjust = FALSE

/obj/item/clothing/under/ship/officercolonial
	name = "Colonial Officer's uniform"
	desc = "A reasonably comfortable piece of clothing made of sweat absorbing materials. This piece of clothing is designed to make you look cool for all the aspiring fleeties out there."
	icon_state = "officercolonial"
	item_color = "officercolonial"
	item_state = "bl_suit"
	sensor_mode = SENSOR_COORDS
	random_sensor = FALSE
	can_adjust = FALSE
