...
/datum/controller/subsystem/star_system/proc/move_existing_object(obj/structure/overmap/OM, datum/star_system/target)
	...
	if(!target.occupying_z)
		...
		target.add_ship(OM)
	if(OM.faction != "kobol" && OM.faction != "solgov") //NT, SGC or whatever don't count as enemies that NT hire you to kill.
...
/datum/star_system/sol
	...
	x = 70
	y = 50
	fleet_type = /datum/fleet/kobol/earth
	alignment = "kobol"
	system_type = list(
		tag = "planet_earth",
		label = "Planetary system",
...
/datum/star_system/lalande21185
	...
	alignment = "kobol"
	fleet_type = /datum/fleet/kobol/border
...
/datum/star_system/sector2/foothold //The last bastion of civilisation.
	...
	y = 40
	alignment = "nanotrasen"
	fleet_type = /datum/fleet/kobol/border/defense //The foothold in the darkness
...
/datum/star_system/proc/generate_badlands()
	...
	for(var/I=0;I<amount,I++){
		...
		if(prob(10))
			...
			var/x = pick(/datum/fleet/wolfpack, /datum/fleet/neutral, /datum/fleet/pirate/raiding, /datum/fleet/boarding, /datum/fleet/kobol/light)
