...
/obj/structure/table/wood/maptable //no specialties here either, just a starmap
	name = "strategic starmap"
	desc = "A brightly illuminated map of the sector complete with real-time updated starmaps, for planning of military operations. A must-have for any serious fleet command endeavour."
	icon = 'icons/obj/smooth_structures/map_table.dmi'
	icon_state = "maptable"

/obj/structure/table/wood/maptable2 //2 of 4, had to split it up for technical reasons
	name = "strategic starmap"
	desc = "A brightly illuminated map of the sector complete with real-time updated starmaps, for planning of military operations. A must-have for any serious fleet command endeavour."
	icon = 'icons/obj/smooth_structures/map_table2.dmi'
	icon_state = "maptable"

/obj/structure/table/wood/maptable3 //3 of 4
	name = "strategic starmap"
	desc = "A brightly illuminated map of the sector complete with real-time updated starmaps, for planning of military operations. A must-have for any serious fleet command endeavour."
	icon = 'icons/obj/smooth_structures/map_table3.dmi'
	icon_state = "maptable"

/obj/structure/table/wood/maptable4 //4 of 4
	name = "strategic starmap"
	desc = "A brightly illuminated map of the sector complete with real-time updated starmaps, for planning of military operations. A must-have for any serious fleet command endeavour."
	icon = 'icons/obj/smooth_structures/map_table4.dmi'
	icon_state = "maptable"
